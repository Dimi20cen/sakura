...
- [Rulebooks](./rulebooks/RULEBOOKS_GUIDE.md): official PDFs, searchable text extracts, and chapter-structured summaries for parity work.
...
- Rulebook source files and extracts: `rulebooks/RULEBOOKS_GUIDE.md`
- Env contract: `ENVIRONMENT.md`
- Seafarers scope and rollout status: `SEAFARERS_MVP.md` and `SEAFARERS_PARITY_CHECKLIST.md`
- UI asset layout and runtime asset registry: `../ui/UI_GUIDE.md`, `../ui/assets/runtime`, and `../ui/src/assets.ts`
